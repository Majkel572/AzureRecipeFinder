...
public class HomeController : Controller
{
    ...
    [HttpPost("getrecipeMobile")]
    [AllowAnonymous]
    public async Task<IActionResult> DoSomething2([FromBody] byte[] image) {
    ...
    [HttpPost("getrecipeMobileZwei")]
    [AllowAnonymous]
    public async Task<IActionResult> DoSomething3([FromBody] IFormFile image) {
